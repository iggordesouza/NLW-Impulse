...
interface FeeadbackContentStepProps {
  feedbackType: FeedbackType;
  onFeedbackRestartRequested: () => void;
  onFeedbackSent: () => void;
}

export function FeeadbackContentStep({ 
  feedbackType,
  onFeedbackRestartRequested,
  onFeedbackSent
}: FeeadbackContentStepProps) {
  ...
  return(
    <>
      ...
      <form onSubmit={handleSubmitFeedback} className="my-8 w-full">
          <textarea 
